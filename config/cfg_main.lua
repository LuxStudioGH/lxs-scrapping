...
Config.DispatchSystem = "ps-dispatch" -- Default: ps-dispatch - Supported: tk_dispatch, cd_dispatch, qs-dispatch, lb-tablet, core_dispatch, origen_police, rcore_dispatch
-- Dispatch set up
Config.Dispatch = {
    ["scrapping"] = {
        code = '10-31',
